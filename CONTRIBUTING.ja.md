...
<p align="left">
  <b>日本語</b> | <a href="CONTRIBUTING.md">English</a>
</p>
...
AI コーディングアシスタント（Antigravity、Claude Code、GitHub Copilot、Gemini CLI 等）を使用して開発を進める場合は、プロジェクトルートの [**`AGENTS.ja.md`**](AGENTS.ja.md) / [English](AGENTS.md) に定義された自律開発プロトコルを遵守させてください。

---

## 5. コミュニティ行動規範

すべての参加者が安全かつ敬意を持って参加できるよう、[行動規範 (CODE_OF_CONDUCT.ja.md)](CODE_OF_CONDUCT.ja.md) / [English](CODE_OF_CONDUCT.md) を定めています。ご理解とご協力をお願いいたします。
