...
<p align="left">
  <a href="README.md">日本語 (Japanese)</a> | <b>English</b>
</p>
...
3. **The Soil: `pipelines/` (`oniwa-pipeline`)**
...
└── crates/
    └── oniwa-lm/               # [The Seed & Engine] Pure Rust SLM crate
        ...
        └── docs/               # Architecture design notes redirect
```
...
- [Project Manifesto (Japanese)](docs/00_oniwa-project-manifesto.md)
- [Data Ingestion Charter (Japanese)](docs/07_data_ingestion_charter.md)
- [Green Energy & Power Tracking (Japanese)](docs/08_green_energy_and_power_tracking.md)
- [Provenance Ledger & Thermal Management (Japanese)](docs/06_thermal_and_end_to_end_provenance.md)
- [oniwa-lm Architecture Design (Japanese)](docs/01_llm_c_architecture.md)
...
- [Contributing Guide (English)](CONTRIBUTING.en.md) / [日本語](CONTRIBUTING.md)
- [AI Agent Protocol (AGENTS.md)](AGENTS.md): Strict workflow rules for autonomous agents
- [Code of Conduct (English)](CODE_OF_CONDUCT.en.md) / [日本語](CODE_OF_CONDUCT.md)
- [Security Policy (English)](SECURITY.en.md) / [日本語](SECURITY.md)
