...
<p align="left">
  <a href="CONTRIBUTING.md">日本語 (Japanese)</a> | <b>English</b>
</p>
...
4. **Legal Clearance & Respect for Creators**:  
   Ingested corpora are strictly limited to copyright-expired public domain works, public legal texts, or permissible open-license materials (MIT, Apache-2.0, CC0). See [Data Ingestion Charter (Japanese)](docs/07_data_ingestion_charter.md) for details.
...
To foster an inclusive and safe environment, all contributors are expected to adhere to our [Code of Conduct (CODE_OF_CONDUCT.en.md)](CODE_OF_CONDUCT.en.md).
